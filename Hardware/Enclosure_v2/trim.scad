...
module trim(with_pcb = true, with_screw = true, thickness = 0.3, angle = 0, explode_dist = 0, solid_holes = true)
{
    ...
    if(solid_holes)
    {
        translate([0, 0.5, 1.25 + explode_dist]) translate([-0.45, -0.70, 0.45]) cube(size = [0.9, 0.4, 0.8]);
    }
}
